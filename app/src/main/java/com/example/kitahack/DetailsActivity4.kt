...
import com.example.kitahack.adapter.PopularJobsAdapterClass2
...
class DetailsActivity4 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.item_jobs_detail2)
    ...
    private fun getBundle(){
        ...
        val obj = intent.getSerializableExtra("object") as PopularJobsAdapterClass2
        Glide.with(this)
            .load(obj.pic)
            .into(picFood)
