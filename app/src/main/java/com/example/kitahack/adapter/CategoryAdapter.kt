...
import com.example.kitahack.adapter.CategoryAdapterClass
...
class CategoryAdapter(var categoryAdapterClass: ArrayList<CategoryAdapterClass>) :
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        holder.categoryName.text = categoryAdapterClass[position].getTitle()
        var picUrl = ""
        when (position) {
            0 -> {
                picUrl = "cat_1"
    ...
    override fun getItemCount(): Int {
        return categoryAdapterClass.size
    }
